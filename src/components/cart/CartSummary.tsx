      ...
      <div className="sticky top-24 rounded-sm border border-border bg-card p-6 lg:p-8 shadow-sm">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex justify-between text-sm">
            ...
            <span className="font-bold text-foreground">2,950,000đ</span>
          </div>
          <div className="flex justify-between text-sm">
            <span className="text-muted-foreground">Vận chuyển (Ước tính)</span>
            <span className="font-bold text-foreground">450,000đ</span>
          </div>
          <div className="flex justify-between text-sm">
            <span className="text-muted-foreground">VAT (10%)</span>
            <span className="font-bold text-foreground">295,000đ</span>
          </div>
          ...
          <div className="flex justify-between text-xl items-end">
            ...
            <span className="font-black text-primary text-2xl">3,695,000đ</span>
          </div>
        </div>
