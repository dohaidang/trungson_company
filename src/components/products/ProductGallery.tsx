...
export function ProductGallery({ images }: ProductGalleryProps) {
  ...
  return (
    <div className="flex flex-col gap-6">
      {/* Main Image */}
      <div className="w-full aspect-[4/3] bg-muted rounded-xl overflow-hidden relative border border-border group cursor-zoom-in">
        <Image
          src={selectedImage}
          alt="Product Image"
          fill
          className="object-cover transition-transform duration-500 hover:scale-150 origin-center"
        />
